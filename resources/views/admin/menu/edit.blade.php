					...
					<form action="{{ route('admin.menu.update', [$menu->id]) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="form-group col-12 col-lg-4">
								...
								<input class="form-control" type="text" name="menu_name" value="{{ $menu->name }}"/>
							...
							<div class="form-group col-12 col-lg-4">
								...
								<div class="input-group">
									...
									<input type="number" class="form-control" min="0" max="4294967295" step=".25" name="price" value="{{ number_format($menu->price, 2, ".", "") }}">
								</div>
