...
@section('title', 'Additional Orders - Add')
	...
	<div class="row">
		<div class="mx-auto col-12 col-lg-10">
			<div class="card dark-shadow mb-5" id="inner-content">
				<div class="card-body">
					<form action="{{ route('admin.bookings.additional-orders.store', [$booking->id]) }}" method="POST" enctype="multipart/form-data" class="form needs-validation" data-continuous-validation="false">
						{{-- HIDDEN FIELDS --}}
						{{ csrf_field() }}
						...
						<div class="card my-2">
							...
							<div class="row card-body">
								...
								<div class="form-group col-12 col-lg-6">
									...
									<div class="input-group">
										<input class="form-control has-spinner" type="number" name="extension" id="extension" value="{{ old('extension') ? old('extension') : '0' }}" min="0" max="4" step="0.5" required>
							...
							<div class="row card-body">
								...
								<div class="form-group col-12">
									...
									<div class="row" id="menuField">
										...
										@php ($index = 0)
										@if (old('menu') || old('count'))
											@foreach (old('menu') as $m)
											{{-- ORIGINAL --}}
												...
												<div class="card h-100">
													<div class="card-body">
														...
														<div class="form-group">
															...
															<input type="number" min="1" class="form-control" name="count[]" value="{{ old("count.{$index}") }}">
										...
										@else
										{{-- ORIGINAL --}}
										<div class="col-12 col-lg-4 my-2 position-relative" id="origMenuForm">
											<div class="card h-100">
												<div class="card-body">
													<div class="form-group">
														<label class="form-label" for="menu">Menu Name</label><br>
														...
														<br><span class="text-danger text-wrap validation">{{ $errors->first('menu.0') }}</span>
													</div>

													<div class="form-group">
														<label for="count" class="form-label">Count</label>
														<input type="number" min="1" class="form-control" name="count[]" value="{{ old('count.0') }}">
														<span class="text-danger text-wrap validation">{{ $errors->first('count.0') }}</span>
													</div>
												</div>
											</div>
										</div>
